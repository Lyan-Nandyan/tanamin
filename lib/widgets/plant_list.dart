                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 6,
                            children: plant.suitableSeasons.map((season) => Chip(label: Text(season))).toList(),
                          ),
                          const SizedBox(height: 4),
                          Text('Suhu: ${plant.minTemp}°C – ${plant.maxTemp}°C'),
                          Text('Kelembapan: ${plant.minHumidity}% – ${plant.maxHumidity}%'),
                          const SizedBox(height: 6),
                          ConvertedPriceText(amount: plant.estimatedCost, currencyOption: option ?? 1),
                        ],
                      ),
                    ),
                  ],
